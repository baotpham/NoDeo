...
(function() {
    ...
    function setEventHandlers() {
        // // Display the tables
        // $("#disp_table_button").click(function() {
        //     table_type = $('#table_select')[0].value
        //     makeRequest('GET', 'TABLE', { type: table_type }).done(function(res) {
        //         response = JSON.parse(res)
        //         selected_titles = []
        //         for (title in response[0]) {
        //             selected_titles.push(titles[title])
        //         }
        //         fillInInformation(selected_titles, response);
        //     });
        // })
    }
